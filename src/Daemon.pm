...
sub accept {
    my $self = shift;
    my $pkg = shift || "Plex::Daemon::ClientConn";
...
sub product_tokens {
    "libwww/modified Plex::Daemon/Plex2";
}



package Plex::Daemon::ClientConn;

use vars qw(@ISA $DEBUG);
use IO::Socket ();
@ISA=qw(IO::Socket::INET);
*DEBUG = \$Plex::Daemon::DEBUG;
...
sub send_status_line {
    ...
    $proto   ||= $Plex::Daemon::PROTO || "HTTP/1.1";
